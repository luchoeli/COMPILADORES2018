...
public class ArbolExpresionGrafico extends JPanel 
{
     ...
     * dibujar.
     */
    public ArbolExpresionGrafico(Nodo raiz) 
    {
          this.raiz = raiz;
    ...
    private void calcularPosicion(Nodo n, int left, int right, int top) 
    {
      ...
      int width = fm.stringWidth(n.getLexema()+"");
    ...
    private void dibujarArbol(Graphics2D g, Nodo n, int puntox, int puntoy, int yoffs) 
    {
     ...
     g.draw(r);
     g.drawString(n.getLexema()+"", r.x + 3, r.y + yoffs);
   ...
   public void paint(Graphics g) 
   {
         ...
         dibujarArbol(g2d, this.raiz, Integer.MAX_VALUE, Integer.MAX_VALUE, 
